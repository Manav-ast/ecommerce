    ...
    <div class="container mx-auto px-6 flex items-center justify-between gap-8">
        ...
        <div class="flex items-center gap-5">
            ...
            <div class="hidden lg:flex flex-col items-end gap-1 text-gray-700 text-left">
                <a href="tel:+918160868450" class="font-semibold text-xs flex items-center gap-1 hover:text-blue-700 transition-colors ltr">
                    <i class="fas fa-phone-alt fa-flip-horizontal"></i>
                    +91 8160868450
                </a>
                <a href="mailto:manavvaishnani.ast@gmail.com" class="font-semibold text-xs flex items-center gap-1 hover:text-blue-700 transition-colors ltr">
            ...
            <nav class="flex items-center gap-6" aria-label="User navigation">
                ...
                <!-- Cart -->
                <a href="/cart" class="group text-gray-700 hover:text-blue-700 transition-colors relative flex flex-col items-center">
                    <div class="text-xl">
                        <i class="fa-solid fa-bag-shopping group-hover:scale-110 transition-transform"></i>
                    </div>
                    <span class="text-[10px] mt-0.5">Cart</span>
                    <span class="absolute -right-2.5 -top-0.5 w-4 h-4 rounded-full flex items-center justify-center bg-blue-500 group-hover:bg-blue-700 text-white text-[9px]">
                        2
                    </span>
                </a>
                ...
                <!-- Account -->
                @guest
                    <a href="{{ url('/register') }}" class="group text-gray-700 hover:text-blue-700 transition-colors relative flex flex-col items-center">
                        <div class="text-xl">
                ...
                @else
                    <a href="{{ url('/profile') }}" class="group text-gray-700 hover:text-blue-700 transition-colors relative flex flex-col items-center">
                        <div class="text-xl">
                            <i class="fa-regular fa-user group-hover:scale-110 transition-transform"></i>
                        </div>
