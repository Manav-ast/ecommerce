...
@section('content')
    <div class="flex justify-center items-center min-h-screen">
        <div class="bg-white shadow-lg rounded-lg p-6 w-full max-w-4xl">
            <!-- Page Title -->
            <h2 class="text-2xl font-bold mb-4 text-gray-800 text-center">Add Page Block</h2>

            <!-- Form -->
            <form id="addPageBlockForm" method="POST">
                @csrf
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addPageBlockForm').on('submit', function(e) {
                e.preventDefault();
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                showErrorToast(response.message ||
                                    'An error occurred while creating the page block.'
                                );
