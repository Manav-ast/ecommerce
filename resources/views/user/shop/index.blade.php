        ...
        <div class="grid grid-cols-[280px,1fr] gap-8">
            ...
            <aside class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="space-y-3">
                    @foreach ($categories as $category)
                        <div class="flex items-center group">
                            ...
                            {{-- {{ dd($categories) }} <!-- Check if products_count exists in the output --> --}}
                ...
                <button id="apply-filters"
                    class="bg-blue-500 border border-blue-500 text-white px-8 py-3 font-medium rounded-lg uppercase flex items-center justify-center gap-2 hover:bg-transparent hover:text-blue-700 transition-all duration-300 w-full mt-2"
                    type="button">
                    Apply Filters
                </button>
            </aside>
