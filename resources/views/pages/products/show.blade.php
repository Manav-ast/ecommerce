            ...
            <div>
                ...
                <div class="grid grid-cols-5 gap-4 mt-4">
                    @foreach ($thumbnailImages as $thumbnail)
                        <img src="{{ asset($thumbnail) }}" alt="{{ $product['name'] }} thumbnail"
            ...
            <div>
                    ...
                    <div class="flex items-center gap-2">
                        @foreach (['XS', 'S', 'M', 'L', 'XL'] as $size)
                            <div class="size-selector">
                                <input type="radio" name="size" id="size-{{ strtolower($size) }}" class="hidden"
                                    value="{{ $size }}">
                    ...
                    <div class="flex items-center gap-2">
                        @foreach (['#fc3d57' => 'red', '#000' => 'black', '#fff' => 'white'] as $color => $name)
                            <div class="color-selector">
                                <input type="radio" name="color" id="{{ $name }}" class="hidden"
                                    value="{{ $name }}">
                                <label for="{{ $name }}"
                ...
                <div class="mt-4">
                    ...
                    <div class="flex border border-gray-300 text-gray-600 divide-x divide-gray-300 w-max">
                        <button class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none"
                    ...
                    <div class="bg-white shadow rounded overflow-hidden group">
                        ...
                        <div class="pt-4 pb-3 px-4">
                            ...
                            <div class="flex items-baseline mb-1 space-x-2">
                                <p class="text-xl text-primary font-semibold">${{ number_format($related['price'], 2) }}
                                </p>
                                <p class="text-sm text-gray-400 line-through">
                                    ${{ number_format($related['old_price'], 2) }}</p>
                            </div>
